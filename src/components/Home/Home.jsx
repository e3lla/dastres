    ...
    return (
     <>
       <div className=" w-[86%] h-[100%] mx-auto px-4">
         ...
         <div className="card w-full bg-[#E2E2E2] rounded-t-2xl rounded-b-none h-[50px] place-items-end mt-[30px] hidden sm:hidden md:block">
         ...
         {/* محصولات دسکتاپ */}
         <div className="w-full h-[639px] bg-[#E2E2E2] rounded-2xl rounded-t-none hidden pr-[5%] 2xl:flex xl:flex lg:flex md:flex">
            <Products/>  
            <Divider />
         </div>

         {/* نسخه sm: تخفیف‌ها داخل قسمت سبز */}
         <div className="w-full justify-center sm:h-[1310px] bg-[#E2E2E2] rounded-2xl sm:flex md:hidden lg:hidden xl:hidden 2xl:hidden flex-col">
            <div className="card w-full bg-[#E2E2E2] rounded-t-2xl rounded-b-none h-[50px] place-items-end mt-[30px]">
              <div className="flex justify-between w-full px-[5%]">
